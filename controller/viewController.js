...
exports.getOverview = async (req, res) => {
    try {
        ...
        const action = await axios.get('http://127.0.0.1:3000/api/v1/movie?genre=action');
        const drama = await axios.get('http://127.0.0.1:3000/api/v1/movie?genre=drama');
        const comedy = await axios.get('http://127.0.0.1:3000/api/v1/movie?genre=comedy');
        const horror = await axios.get('http://127.0.0.1:3000/api/v1/movie?genre=horror');
